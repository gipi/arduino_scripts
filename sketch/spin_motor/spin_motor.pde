...
void motorOnThenOffWithSpeed(){
  ...
  int onSpeed = 20;  // a number between 0 (stopped) and 255 (full speed) 
  int onTime = 2500;  //the number of milliseconds for the motor to turn on for
  
  int offSpeed = 250;  // a number between 0 (stopped) and 255 (full speed) 
  int offTime = 100; //the number of milliseconds for the motor to turn off for
